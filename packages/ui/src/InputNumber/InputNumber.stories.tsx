...
export const Overview: StoryFn<typeof InputNumber> = (args) => {
  return <InputNumber startSlot={<IconVariable size="12px" />} placeholder="Variable x..." size="sm" {...args} />
}
...
export const Controlled: StoryFn<typeof InputNumber> = () => {
  ...
  return (
    <Flex gap="xs">
      <InputNumber variant="default" size="sm" value={val} onValueChange={setVal} />
