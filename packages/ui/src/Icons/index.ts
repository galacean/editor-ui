...
export { default as IconAnimatorClipFile } from './Files/Film'
export { default as IconFontFile } from './Files/Font'
export { default as IconLottieFile } from './Files/Lottie'
export { default as IconPrefabFile } from './Files/Prefab'
export { default as IconSceneFile } from './Files/Scene'
export { default as IconShaderFile } from './Files/Shader'
export { default as IconSpineSkeletonFile } from './Files/Skel'
export { default as IconSpineFile } from './Files/Spine'
export { default as IconSpriteFile } from './Files/Sprite'
